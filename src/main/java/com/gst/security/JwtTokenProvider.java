...
public class JwtTokenProvider {
    ...
    @Value("${app.jwt.secret:mySecretKeyForJWTTokenGenerationAndValidationPurposeOnly}")
    private String jwtSecret;

    @Value("${app.jwt.expiration:1800000}") // 30 minutes in milliseconds
